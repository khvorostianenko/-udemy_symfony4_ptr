...
Encore
    ...
    .setOutputPath('public/build/') // куда выгружать результат
     ...
     */
    .cleanupOutputBeforeBuild() // очищаем папку перед созданием
    .enableBuildNotifications()
    .enableSourceMaps(!Encore.isProduction()) // необходимо если есть типа TypeScript
