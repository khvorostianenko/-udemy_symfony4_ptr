 ...
 */
final class Version20181224130833 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE notification (
                                ...
                                micro_post_id INT DEFAULT NULL, 
                                liked_by_id INT DEFAULT NULL, 
                                seen TINYINT(1) NOT NULL, 
                                discr VARCHAR(255) NOT NULL, 
                                INDEX IDX_BF5476CAA76ED395 (user_id), 
                                INDEX IDX_BF5476CA11E37CEA (micro_post_id), 
                                INDEX IDX_BF5476CAB4622EC2 (liked_by_id), 
                                PRIMARY KEY(id)
